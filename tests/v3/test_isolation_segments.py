...
class TestIsolationSegments(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        self.client.get.return_value = self.mock_response(
            "/v3/isolation_segments", HTTPStatus.OK, None, "v3", "isolation_segments", "GET_response.json"
        )
    ...
    def test_create(self):
        self.client.post.return_value = self.mock_response(
            "/v3/isolation_segments", HTTPStatus.OK, None, "v3", "isolation_segments", "POST_response.json"
        )
        result = self.client.v3.isolation_segments.create(
            "isolation_segment_id",
        ...
        self.client.post.assert_called_with(
            ...
            files=None,
            json={
                "name": "isolation_segment_id",
                "metadata": {"labels": {"key_label": "value_label"}, "annotations": {"key_annotation": "value_annotation"}},
            },
        )
        self.assertIsNotNone(result)
        self.assertIsInstance(result, Entity)
    ...
    def test_remove(self):
        self.client.delete.return_value = self.mock_response(
            "/v3/isolation_segments/isolation_segment_id", HTTPStatus.NO_CONTENT, None
        )
    ...
    def test_entitle_organizations(self):
        self.client.post.return_value = self.mock_response(
            ...
            "v3",
            "isolation_segments",
            "POST_{id}_relationships_organizations_response.json",
        )
        result = self.client.v3.isolation_segments.entitle_organizations("isolation_segment_id", "org_id_1", "org_id_2")
        self.client.post.assert_called_with(
            self.client.post.return_value.url, files=None, json={"data": [{"guid": "org_id_1"}, {"guid": "org_id_2"}]}
        )
    ...
    def test_revoke_organization(self):
        self.client.delete.return_value = self.mock_response(
            "/v3/isolation_segments/isolation_segment_id/relationships/organizations/org_id", HTTPStatus.NO_CONTENT, None
        )
    ...
    def test_list_entitled_organizations(self):
        self.client.get.return_value = self.mock_response(
            ...
            "v3",
            "isolation_segments",
            "GET_{id}_relationships_organizations_response.json",
        )
    ...
    def test_list_entitled_spaces(self):
        self.client.get.return_value = self.mock_response(
            ...
            "v3",
            "isolation_segments",
            "GET_{id}_relationships_spaces_response.json",
        )
