...
class SpaceManager(EntityManager[Entity]):
    def __init__(self, target_endpoint: str, client: "CloudFoundryClient"):
        super().__init__(target_endpoint, client, "/v3/spaces")

    def create(self, name: str, org_guid: str) -> Entity:
        return super()._create(dict(name=name, relationships=dict(organization=ToOneRelationship(org_guid))))

    def update(self, space_guid: str, name: str) -> Entity:
        return super()._update(space_guid, dict(name=name))
