...
class TestPolicies(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        self.client.get.return_value = self.mock_response('/networking/v1/external/policies',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_delete(self):
        self.client.delete.return_value = self.mock_response('/networking/v1/external/policies/delete',
                                                             HTTPStatus.OK,
                                                             None)
