...
class TestApps(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        self.client.get.return_value = self.mock_response('/v3/apps',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_get(self):
        self.client.get.return_value = self.mock_response('/v3/apps/app_id',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_get_then_start(self):
        self.client.get.return_value = self.mock_response('/v3/apps/app_id', HTTPStatus.OK, None,
                                                          'v3', 'apps', 'GET_{id}_response.json')
        self.client.post.return_value = self.mock_response('/v3/apps/app_id/actions/start', HTTPStatus.OK, None,
