...
class TestApps(unittest.TestCase, AbstractTestCase):
    ...
    def test_get_then_space(self):
        get_app = mock_response('/v3/apps/app_id', HTTPStatus.OK, None, 'v3', 'apps', 'GET_{id}_response.json')
        get_space = mock_response('/v3/spaces/2f35885d-0c9d-4423-83ad-fd05066f8576', HTTPStatus.OK, None,
    ...
    def test_get_then_start(self):
        self.client.get.return_value = mock_response('/v3/apps/app_id', HTTPStatus.OK, None,
                                                     'v3', 'apps', 'GET_{id}_response.json')
        self.client.post.return_value = mock_response('/v3/apps/app_id/actions/start', HTTPStatus.OK, None,
