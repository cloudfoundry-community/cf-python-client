...
class TestOrganizations(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        self.client.get.return_value = self.mock_response('/v3/organizations',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_get(self):
        self.client.get.return_value = self.mock_response('/v3/organizations/organization_id',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_get_default_domain(self):
        self.client.get.return_value = self.mock_response('/v3/organizations/organization_id/domains/default',
                                                          HTTPStatus.OK,
                                                          None,
                                                          'v3', 'organizations',
    ...
    def test_get_usage_summary(self):
        self.client.get.return_value = self.mock_response('/v3/organizations/organization_id/usage_summary',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_main_get_organizations(self):
        with patch('cloudfoundry_client.main.main.build_client_from_configuration',
                   new=lambda: self.client):
            self.client.get.return_value = self.mock_response('/v3/organizations/24637893-3b77-489d-bb79-8466f0d88b52',
                                                              HTTPStatus.OK,
                                                              None,
                                                              'v3', 'organizations', 'GET_{id}_response.json')
            main.main()
