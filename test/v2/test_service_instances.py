...
class TestServiceInstances(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        ...
        cpt = reduce(lambda increment, _: increment + 1,
                     self.client.v2.service_instances.list(space_guid='space_guid', service_plan_guid='plan_id'), 0)
    ...
    def test_main_list_service_instances(self):
        with patch('cloudfoundry_client.main.main.build_client_from_configuration',
            ...
            self.client.get.return_value = self.mock_response('/v2/service_instances',
                                                              HTTPStatus.OK,
                                                              None,
                                                              'v2', 'service_instances', 'GET_response.json')
            main.main()
