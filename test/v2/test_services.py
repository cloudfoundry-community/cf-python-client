...
class TestServices(unittest.TestCase, AbstractTestCase):
    ...
    def test_list(self):
        self.client.get.return_value = self.mock_response('/v2/services?q=label%3Asome_label',
                                                          HTTPStatus.OK,
                                                          None,
    ...
    def test_main_list_services(self):
        with patch('cloudfoundry_client.main.main.build_client_from_configuration',
            ...
            self.client.get.return_value = self.mock_response('/v2/services',
                                                              HTTPStatus.OK,
                                                              None,
                                                              'v2', 'services', 'GET_response.json')
            main.main()
    ...
    def test_main_get_service(self):
        with patch('cloudfoundry_client.main.main.build_client_from_configuration',
                   new=lambda: self.client):
            self.client.get.return_value = self.mock_response('/v2/services/2c883dbb-a726-4ecf-a0b7-d65588897e7f',
                                                              HTTPStatus.OK,
                                                              None,
                                                              'v2', 'services', 'GET_{id}_response.json')
            main.main()
