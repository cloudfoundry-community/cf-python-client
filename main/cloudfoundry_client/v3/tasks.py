...
class TaskManager(EntityManager):
    ...
    def create(self, application_guid: str, command: str,
               name: Optional[str] = None, disk_in_mb: Optional[int] = None, memory_in_mb: Optional[int] = None,
               droplet_guid: Optional[str] = None) -> Entity:
