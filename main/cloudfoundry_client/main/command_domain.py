...
class CommandDomain(object):
    def __init__(self, display_name: str, entity_name: str, filter_list_parameters: list,
                 api_version: str = 'v2', name_property: str = 'name',
                 allow_retrieve_by_name: bool = False, allow_creation: bool = False, allow_deletion: bool = False,
